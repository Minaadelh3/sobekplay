    ...
    return (
        <div className="min-h-screen bg-[#050608] text-white flex font-sans selection:bg-accent-gold/30">
            ...
            <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative">
                ...
                {/* Mobile Top Bar */}
                <header className="lg:hidden bg-[#0F1218] border-b border-white/5 p-4 flex justify-between items-center z-40">
                ...
                <AnimatePresence>
                    {isMobileMenuOpen && (
                        ...
                        >
                            <div className="w-80 h-full relative z-50">
                ...
                {/* Main Content Area */}
                <div className="flex-1 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                    <Outlet />
                </div>
            </main>
        </div>
