...
const TitleDetails: React.FC<TitleDetailsProps> = ({ posters }) => {
  ...
  if (!poster)
    return (
      <div className="min-h-screen bg-nearblack pt-32 text-center text-white">
        Title not found
      </div>
    );
  ...
  return (
    <div className="relative min-h-screen bg-nearblack text-white">
      {/* Background */}
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          >
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-white/10 rounded-full text-xs font-semibold text-accent-gold uppercase tracking-wider"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="bg-white/10 backdrop-blur-md px-6 py-4 rounded-md font-bold hover:bg-white/20 transition-all">
                Add to My List
              </button>
      ...
      {/* 🔥 Feedback Section */}
      <div className="relative z-10 px-4 md:px-24 pb-32 mt-24">
